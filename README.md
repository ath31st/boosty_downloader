...
Boosty Downloader - это приложение для загрузки контента (видео, изображения, текст, файлы и ссылки)
...
- Если у вас возникнут проблемы с запуском на Windows из-за отсутствия WebView2Loader.dll.
