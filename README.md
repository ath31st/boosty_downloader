...
Существует в двух версиях: консольном и графическом. Обе версии поддерживают Linux и Windows.
...
- В GUI можно остановить текущую загрузку кнопкой Stop.
...
- Папка поста: `{дата} {название} [{id}]`. Имена постов и сохраненных папок могут не совпадать, это сделано, чтобы не ломать пути в файловой системе вашей ОС.
