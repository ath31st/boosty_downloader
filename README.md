...
2. Установите `ffmpeg`(например, [с этого сайта](https://www.gyan.dev/ffmpeg/builds/)) и добавьте его в PATH.
3. Запустите приложение в зависимости от вашей системы:
...
- Сделать возможность автоматического извлечение аксесс и рефреш токенов из браузера.
- Добавить возможность изменения значения лимита постов.
